revengeonblood//META{"name":"AnimatedStatus","source":"https://raw.githubusercontent.com/revengeonblood/BetterDiscord-Animated-Status/master/animated-status.plugin.js","website":"https://github.com/revengeonblood/BetterDiscord-Animated-Status"}*//
	...
	strerror: (req) => {
		...
		for (const s of ["errors", "custom_status", "text", "_errors", 0, "message"])
			if ((json == undefined) || ((json = json[s]) == undefined))
				return "Internal. Report at github.com/revengeonblood/BetterDiscord-Animated-Status";
